...
int main() {
	...
	Graphic cube = default_geometry::cube(texture, program, 15.0f, 0.1f, 15.0f);
	...
	SpotLight spot(glm::vec3(0.0f, 2.0f, 0.0f), glm::vec3(0.0f, -1.0f, 0.0f), glm::vec3(1.0f, 1.0f, 1.0f), 0.05f, 0.2f, 0.0f, 30, program);
