...
int main() {
	...
	glm::ivec2 texture_resolution = glm::ivec2(512, 339);
	...
	fft_solver.fft(*texture0, *texture1, FFFT2::xy, 64);
	fft_solver.i_fft(*texture1, *texture0, FFFT2::xy, 64);
	//fft_solver.shift(*texture1, *texture0, glm::ivec3(texture0->get_size() / 2, 0));
