...
//fft_solver.inverse_dft(*complex_texture, FFFT::XY);
	...
	while (!window.should_close()) {
		...
		window.set_window_resolution(texture.get_size());
		...
		fb.blit_to_screen(texture.get_size(), window.get_framebuffer_resolution(), Framebuffer::Channel::COLOR, Framebuffer::Filter::LINEAR);
