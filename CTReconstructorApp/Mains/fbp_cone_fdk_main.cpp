...
int main() {
	...
	//solver->read_projections("C:/Users/furkan.unsal/Desktop/Data3/[vg-data]20240802111906.478/projektion", 1000, 1000, 1, 2, volume_dimentions.x, volume_dimentions.y, projection_count);
	
	solver->log_normalize_projections(95.0 / 255);
	//solver->log_normalize_projections(48.0 / 255);
	//solver->log_normalize_projections(26.8 / 255);
