...
namespace widget {
	...
	template<>
	inline Box& DefaultStyle::apply<Box>(Box& widget) {
	...
	template<>
	inline Grid& DefaultStyle::apply<Grid>(Grid& widget) {
		widget.margin = glm::vec4(0);
	...
	template<>
	inline Stack& DefaultStyle::apply<Stack>(Stack& widget) {
		widget.margin = glm::vec4(0);
		widget.padding = glm::vec4(0);
		widget.target_size = glm::vec2(GUIDynamic::avail);
		widget.min_size = glm::vec2(GUIDynamic::fit);
	...
	template<>
	inline Container& DefaultStyle::apply<Container>(Container& widget) {
		apply<Grid>(widget);
		return widget;
	}
	...
	template<>
	inline Label& DefaultStyle::apply<Label>(Label& widget) {
		apply<Container>(widget);
	...
	template<>
	inline TextInput& DefaultStyle::apply<TextInput>(TextInput& widget) {
		apply<Container>(widget);
	...
	template<>
	inline Slider& DefaultStyle::apply<Slider>(Slider& widget) {
		apply<Container>(widget);
		apply(widget.head);
		apply(widget.background);
	...
	template<>
	inline DragFloat& DefaultStyle::apply<DragFloat>(DragFloat& widget) {
	...
	template<>
	inline Button& DefaultStyle::apply<Button>(Button& widget) {
		apply<Container>(widget);
		apply(widget.background);
		apply(widget.label);
	...
	template<>
	inline ImageButton& DefaultStyle::apply<ImageButton>(ImageButton& widget) {
		apply<Container>(widget);
		apply(widget.image);
		apply(widget.background);
	...
	template<>
	inline CheckBox& DefaultStyle::apply<CheckBox>(CheckBox& widget) {
		apply<Container>(widget);
		apply(widget.image);
		apply(widget.background);
	...
	template<>
	inline ComboBox& DefaultStyle::apply<ComboBox>(ComboBox& widget) {
		apply<Container>(widget);
		apply(widget.background);
		apply(widget.label);
	...
	template<>
	inline ComboBoxItem& DefaultStyle::apply<ComboBoxItem>(ComboBoxItem& widget) {
		apply<Container>(widget);
		apply(widget.background);
		apply(widget.label);
	...
	template<>
	inline Menu& DefaultStyle::apply<Menu>(Menu& widget) {
		apply<Container>(widget);
		apply(widget.background);
		apply(widget.label);
		apply(widget.dropdown);
	...
	template<>
	inline MenuItem& DefaultStyle::apply<MenuItem>(MenuItem& widget) {
		apply<Container>(widget);
		apply(widget.background);
		apply(widget.label);
	...
	template<>
	inline WindowControls& DefaultStyle::apply<WindowControls>(WindowControls& widget) {
		apply<Stack>(widget);
	...
	template<>
	inline MenuBar& DefaultStyle::apply<MenuBar>(MenuBar& widget) {
		apply<Grid>(widget);
		apply(widget.background);
