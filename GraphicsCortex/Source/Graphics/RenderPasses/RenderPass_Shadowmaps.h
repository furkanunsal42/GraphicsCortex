...
public:
	...
	std::array<glm::vec3, 8> get_frustum_corners(Camera& camera, float near_plane, float far_plane);
	...
	TextureBase2::DepthStencilTextureFormat shadowmap_format = Texture2D::DepthStencilTextureFormat::DEPTH_COMPONENT32F;
