...
Framebuffer Framebuffer::get_current_draw()
{
	GLint bound_framebuffer_draw_id = 0;
	GLCall(glGetIntegerv(GL_DRAW_FRAMEBUFFER_BINDING, &bound_framebuffer_draw_id));
	return Framebuffer(bound_framebuffer_draw_id, false);
}

Framebuffer Framebuffer::get_current_read()
{
	GLint bound_framebuffer_read_id = 0;
	GLCall(glGetIntegerv(GL_READ_FRAMEBUFFER_BINDING, &bound_framebuffer_read_id));
	return Framebuffer(bound_framebuffer_read_id, false);
}
...
bool Framebuffer::is_unique()
{
	return is_framebuffer_unique;
}
...
void Framebuffer::release()
{
	...
	if (id.value == 0 || !is_framebuffer_unique) return;
...
{
	if (!is_framebuffer_unique) {
		std::cout << "[OpenGL Error] A Framebuffer that generated by Framebuffer::get_current() tried to attach_color() but clone Framebuffers is not allowed to call this function" << std::endl;
		ASSERT(false);
	}
	if (id.value == 0) {
		std::cout << "[OpenGL Error] Screen Framebuffer tried to attach_color() but Screen is not allowed to call this function" << std::endl;
...
{
	if (!is_framebuffer_unique) {
		std::cout << "[OpenGL Error] A Framebuffer that generated by Framebuffer::get_current() tried to deattach_color() but clone Framebuffers is not allowed to call this function" << std::endl;
		ASSERT(false);
	}
	if (id.value == 0) {
...
{
	if (!is_framebuffer_unique) {
		std::cout << "[OpenGL Error] A Framebuffer that generated by Framebuffer::get_current() tried to attach_depth() but clone Framebuffers is not allowed to call this function" << std::endl;
		ASSERT(false);
	}
	if (id.value == 0) {
		std::cout << "[OpenGL Error] Screen Framebuffer tried to attach_depth() but Screen is not allowed to call this function" << std::endl;
...
{
	if (!is_framebuffer_unique) {
		std::cout << "[OpenGL Error] A Framebuffer that generated by Framebuffer::get_current() tried to attach_depth_layered() but clone Framebuffers is not allowed to call this function" << std::endl;
		ASSERT(false);
	}
	if (id.value == 0) {
		std::cout << "[OpenGL Error] Screen Framebuffer tried to attach_depth_layered() but Screen is not allowed to call this function" << std::endl;
...
{
	if (!is_framebuffer_unique) {
		std::cout << "[OpenGL Error] A Framebuffer that generated by Framebuffer::get_current() tried to attach_stencil() but clone Framebuffers is not allowed to call this function" << std::endl;
		ASSERT(false);
	}
	if (id.value == 0) {
		std::cout << "[OpenGL Error] Screen Framebuffer tried to attach_stencil() but Screen is not allowed to call this function" << std::endl;
...
{
	if (!is_framebuffer_unique) {
		std::cout << "[OpenGL Error] A Framebuffer that generated by Framebuffer::get_current() tried to attach_stencil_layered() but clone Framebuffers is not allowed to call this function" << std::endl;
		ASSERT(false);
	}
	if (id.value == 0) {
		std::cout << "[OpenGL Error] Screen Framebuffer tried to attach_stencil_layered() but Screen is not allowed to call this function" << std::endl;
...
{
	if (!is_framebuffer_unique) {
		std::cout << "[OpenGL Error] A Framebuffer that generated by Framebuffer::get_current() tried to attach_depth_stencil() but clone Framebuffers is not allowed to call this function" << std::endl;
		ASSERT(false);
	}
	if (id.value == 0) {
		std::cout << "[OpenGL Error] Screen Framebuffer tried to attach_depth_stencil() but Screen is not allowed to call this function" << std::endl;
...
{
	if (!is_framebuffer_unique) {
		std::cout << "[OpenGL Error] A Framebuffer that generated by Framebuffer::get_current() tried to attach_depth_stencil_layered() but clone Framebuffers is not allowed to call this function" << std::endl;
		ASSERT(false);
	}
	if (id.value == 0) {
		std::cout << "[OpenGL Error] Screen Framebuffer tried to attach_depth_stencil_layered() but Screen is not allowed to call this function" << std::endl;
...
{
	if (!is_unique()) {
		std::cout << "[OpenGL Error] A Framebuffer that generated by Framebuffer::get_current() tried to update_activated_draw_buffers() but clone Framebuffers is not allowed to call this function" << std::endl;
		ASSERT(false);
	}
	if (id.value == 0) {
...
void Framebuffer::blit(
	...
	if (target.id.value != 0 && target.is_unique())
...
void Framebuffer::blit(
	Framebuffer&& target,
	int32_t self_x0, int32_t self_y0,
	int32_t self_x1, int32_t self_y1,
	int32_t target_x0, int32_t target_y0,
	int32_t target_x1, int32_t target_y1,
	Channel channel, Filter filter)
{
...
void Framebuffer::blit(
	Framebuffer&& target,
	glm::ivec2 self_offset, 
	glm::ivec2 self_size, 
	glm::ivec2 target_offset, 
	glm::ivec2 target_size, 
	Channel channel, Filter filter
) {
	blit(
...
Framebuffer::Framebuffer(uint32_t id, bool is_framebuffer_unique) : 
	id(id), is_framebuffer_unique(is_framebuffer_unique)
{ 
	if (id == 0 || !is_framebuffer_unique)
