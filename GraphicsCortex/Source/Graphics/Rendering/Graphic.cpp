...
Graphic::Graphic(Mesh mesh) : mesh(mesh) {}

Graphic::Graphic(BindlessMaterial material) : material(material) {}

Graphic::Graphic(Mesh mesh, BindlessMaterial material) : material(material), mesh(mesh) {}
...
void Graphic::set_mesh(Mesh mesh) {
	this->mesh = mesh;
	*_is_mesh_loaded = true;
}

void Graphic::set_material(BindlessMaterial material) {
