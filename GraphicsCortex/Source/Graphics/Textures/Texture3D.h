...
public:
	...
	WrapMode wrap_w = WrapMode::CLAMP;
	...
	void copy_to_texture(Texture3D& target_texture, int32_t self_mipmap = 0, int32_t target_mipmap = 0);
	void copy_to_texture(Texture3D& target_texture, int32_t self_mipmap, int32_t target_mipmap, glm::ivec3 copy_size, glm::ivec3 self_offset = glm::ivec3(0), glm::ivec3 target_offset = glm::ivec3(0));
	...
	void clear(glm::ivec4 clear_data, int x, int y, int z, int width, int height, int depth, int mipmap_target = 0);
	void clear(glm::uvec4 clear_data, int x, int y, int z, int width, int height, int depth, int mipmap_target = 0);
