...
public:
	...
	GraphRenderer(std::string font_path, glm::vec3 region_min = glm::vec3(-5, -5, -5), glm::vec3 region_max = glm::vec3(5, 5, 5), glm::vec3 scale = glm::vec3(1), glm::ivec2 sample_rate = glm::ivec2(16, 4));
	...
	void load_data(Buffer& buffer_source, glm::vec2 source_region_min, glm::vec2 source_region_max);
