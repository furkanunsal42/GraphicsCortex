...
public:
	...
	std::unique_ptr<Buffer> create_bitangent_buffer(size_t vertex_offset_count, size_t buffer_offset_in_bytes, size_t vertex_count) const;
	std::unique_ptr<Buffer> create_bitangent_buffer(size_t vertex_offset_count = 0) const;
