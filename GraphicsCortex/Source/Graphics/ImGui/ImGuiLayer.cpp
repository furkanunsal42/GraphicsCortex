...
void ImGuiLayer::begin_dockspace(glm::ivec2 dockspace_begin, glm::ivec2 dockspace_end) {
	// Note: Switch this to true to enable dockspace
	static bool dockspaceOpen = true;
	static bool opt_fullscreen_persistant = true;
	bool opt_fullscreen = opt_fullscreen_persistant;
	...
	if (opt_fullscreen) {
		...
		//ImGui::SetNextWindowPos(viewport->Pos);
		//ImGui::SetNextWindowSize(viewport->Size);
        ImGui::SetNextWindowPos(ImVec2(viewport->Pos.x + dockspace_begin.x, viewport->Pos.y + dockspace_begin.y));
        ImGui::SetNextWindowSize(ImVec2(dockspace_end.x - dockspace_begin.x, dockspace_end.y - dockspace_begin.y));
        ImGui::SetNextWindowViewport(viewport->ID);
		ImGui::PushStyleVar(ImGuiStyleVar_WindowRounding, 0.0f);
		ImGui::PushStyleVar(ImGuiStyleVar_WindowBorderSize, 0.0f);
		window_flags |= ImGuiWindowFlags_NoTitleBar | ImGuiWindowFlags_NoCollapse | ImGuiWindowFlags_NoResize | ImGuiWindowFlags_NoMove;
