...
public:
	...
	PointLight_s(const glm::vec3& position, const glm::vec3& color, float constant_term, float linear_term, float exponential_term) :
		obj(std::make_shared<PointLight>(position, color, constant_term, linear_term, exponential_term)) {}
...
public:
	...
	SpotLight_s(const glm::vec3& position, const glm::vec3& direction, const glm::vec3& color, float constant_term, float linear_term, float exponential_term, float angle) :
		obj(std::make_shared<SpotLight>(position, direction, color, constant_term, linear_term, exponential_term, angle)) {}
