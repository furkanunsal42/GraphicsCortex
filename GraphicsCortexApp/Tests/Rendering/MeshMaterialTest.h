...
public:
	...
	bool run() {
		...
		ModelMaterial::SingleMaterial single_mat;
		single_mat.albedo_image = Image("C:/dev/GraphicsCortex/GraphicsCortex/Models/Sponza/textures/arch_stone_wall_01_BaseColor.png", 3, false);
		single_mat.normal_image = Image("C:/dev/GraphicsCortex/GraphicsCortex/Models/Sponza/textures/arch_stone_wall_01_Normal.png", 3, false);
		single_mat.roughness_image = Image("C:/dev/GraphicsCortex/GraphicsCortex/Models/Sponza/textures/arch_stone_wall_01_Roughness.png", 1, false);
		single_mat.metallic_image = Image("C:/dev/GraphicsCortex/GraphicsCortex/Models/Sponza/textures/arch_stone_wall_01_Metalness.png", 1, false);
		//single_mat.ambiant_occlusion_image = Image("../GraphicsCortex/Images/orange.png", 4, false);
		ModelMaterial material;
		material.add_material(std::move(single_mat));

		std::shared_ptr<MeshMaterial> mesh_material = std::make_shared<MeshMaterial>();
		mesh_material->load_material(material);

		Scene scene;

		std::shared_ptr<Entity> entity_a = std::make_shared<Entity>();

		Asset sculpture("../GraphicsCortex/Models/Sponza/Sponza.fbx");
