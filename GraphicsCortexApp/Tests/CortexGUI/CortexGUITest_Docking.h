...
public:
	...
	bool run() {
		...
		auto gui_window2 = GUIWindowHierarchy::get().create_window<GUIWindow>(gui_window);
		auto gui_window3 = GUIWindowHierarchy::get().create_window<GUIWindow>(gui_window);
		auto gui_window4 = GUIWindowHierarchy::get().create_window<GUIWindow>(gui_window);
		auto gui_window5 = GUIWindowHierarchy::get().create_window<GUIWindow>(gui_window);

		gui_window->window->set_window_name("1");
