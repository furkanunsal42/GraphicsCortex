...
int main() {
	...
	dragon->material->_pbr_albedo = std::make_shared<Texture2D>(1024, 1024, Texture2D::ColorTextureFormat::RGBA8, 1, 0, 0);
	dragon->material->_pbr_albedo->load_data_async("../GraphicsCortex/Images/orange.png", Texture2D::ColorFormat::RGBA, Texture2D::Type::UNSIGNED_BYTE, 0);
